...
{           
    ...
    private int DIFF_MIN_WIDTH = 20;  
    private int DIFF_MIN_HEIGHT = 25;  
    
    
    public void setSize(Point initialLocation, Dimension initialDimension){
    ...
    public FullResizibleFrame(Point initialLocation, Dimension initialDimension)        
    {        
